...
#ifndef QT_NO_TOOLTIP
        buttonMinimizeFee->setToolTip(QApplication::translate("SendCoinsDialog", "Hide transaction fee settings", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
"Note:  Since the fee is calculated on a per-byte basis, a fee of \"100 satoshis per kB\" for a transaction size of 500 bytes (half of 1 kB) would ultimately yield a fee of only 50 satoshis.", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        labelCustomFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "When there is less transaction volume than space in the blocks, miners as well as relaying nodes may enforce a minimum fee. Paying only this minimum fee is just fine, but be aware that this can result in a never confirming transaction once there is more demand for bitcoin transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        labelBalanceName->setText(QApplication::translate("SendCoinsDialog", "Balance:", Q_NULLPTR));
    } // retranslateUi
