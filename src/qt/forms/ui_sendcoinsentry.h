...
#endif // QT_NO_TOOLTIP
        addAsLabel->setPlaceholderText(QApplication::translate("SendCoinsEntry", "Enter a label for this address to add it to the list of used addresses", Q_NULLPTR));
        amountLabel->setText(QApplication::translate("SendCoinsEntry", "A&mount:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        payAmount->setToolTip(QApplication::translate("SendCoinsEntry", "The amount to send in the selected unit", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        checkboxSubtractFeeFromAmount->setToolTip(QApplication::translate("SendCoinsEntry", "The fee will be deducted from the amount being sent. The recipient will receive less bitcoins than you enter in the amount field. If multiple recipients are selected, the fee is split equally.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the bitcoin: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the Bitcoin network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
