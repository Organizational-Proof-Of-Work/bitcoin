...
#endif // QT_NO_TOOLTIP
        messageIn_SM->setPlaceholderText(QApplication::translate("SignVerifyMessageDialog", "Enter the message you want to sign here", Q_NULLPTR));
        signatureLabel_SM->setText(QApplication::translate("SignVerifyMessageDialog", "Signature", Q_NULLPTR));
        signatureOut_SM->setPlaceholderText(QApplication::translate("SignVerifyMessageDialog", "Click \"Sign Message\" to generate signature", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_SHORTCUT
#ifndef QT_NO_TOOLTIP
        messageIn_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The signed message to verify", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        messageIn_VM->setPlaceholderText(QApplication::translate("SignVerifyMessageDialog", "The signed message to verify", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        signatureIn_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The signature given when the message was signed", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        signatureIn_VM->setPlaceholderText(QApplication::translate("SignVerifyMessageDialog", "The signature given when the message was signed", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
